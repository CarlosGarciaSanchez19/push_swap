...
#    Updated: 2024/11/17 20:53:00 by carlosg2         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = push_swap.c push_swap_utils.c push_swap_utils2.c push_swap_utils3.c ft_atoi.c ft_printf.c ft_strdup.c \
ft_printf_utils.c ft_putstr_fd.c ft_putchar_fd.c ft_putnbr_fd.c ft_strlen.c ft_strcmp.c \
...
ft_lstmap_bonus.c obt_inst_fst_phase.c apply_inst_fst_phase.c
...
$(NAME): $(OBJS) main.c
	ar rcs $(NAME).a $(OBJS)
	cc $(CFLAGS) main.c $(NAME).a -o $(NAME)
...
clean:
	rm -f $(OBJS) $(BOBJS) main.o checker.o
